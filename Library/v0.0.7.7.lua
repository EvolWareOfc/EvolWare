...
function EvolLibrary:CreateWindow(config)
	...
	hideBtn.Size = UDim2.new(0, 24, 0, 24); hideBtn.Position = UDim2.new(1, -55, 0, 10)
	hideBtn.BackgroundTransparency = 1; hideBtn.Text = "-"
	hideBtn.TextColor3 = Window.Theme.TextMuted; hideBtn.Font = Enum.Font.GothamBold
	hideBtn.TextSize = 16; hideBtn.Parent = headerFrame
	...
	closeBtn.TextColor3 = Color3.fromRGB(220, 60, 60); closeBtn.Font = Enum.Font.GothamBold
	closeBtn.TextSize = 14; closeBtn.Parent = headerFrame
	...
	hideBtn.MouseButton1Click:Connect(function()
		...
		if isMinimized then
			hideBtn.Text = "+"
			TweenService:Create(mainFrame, TweenInfo.new(0.4, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 320, 0, 60)}):Play()
		else
			hideBtn.Text = "-"
			TweenService:Create(mainFrame, TweenInfo.new(0.4, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 320, 0, 550)}):Play()
		end
	end)
